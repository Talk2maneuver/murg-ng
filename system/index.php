                        ...
                        <div class="widget widget-account-invoice-three">
                            <div class="widget-heading">
                                ...
                                <div class="wallet-balance">
                                    ...
                                    $yearly_sales_query = $con->query("SELECT SUM(CAST(subtotal AS DECIMAL(10,2)) - (CAST(item_discount AS DECIMAL(10,2)) * CAST(quantity AS SIGNED))) as total_sales FROM orders");
                            ...
                            <div class="widget-amount">
                                ...
                                $month = date('m');
                                if ($facilityID) {
                                    $monthly_sales_query = $con->query("SELECT SUM(CAST(subtotal AS DECIMAL(10,2)) - (CAST(item_discount AS DECIMAL(10,2)) * CAST(quantity AS SIGNED))) as total_sales FROM orders WHERE MONTH(creation) = '$month' AND facilityID = '$facilityID'");
                                    ...
                                    $monthly_sales_query = $con->query("SELECT SUM(CAST(subtotal AS DECIMAL(10,2)) - (CAST(item_discount AS DECIMAL(10,2)) * CAST(quantity AS SIGNED))) as total_sales FROM orders WHERE MONTH(creation) = '$month'");
                                ...
                                $today = date('Y-m-d');
                                if ($facilityID) {
                                    $daily_sales_query = $con->query("SELECT SUM(CAST(subtotal AS DECIMAL(10,2)) - (CAST(item_discount AS DECIMAL(10,2)) * CAST(quantity AS SIGNED))) as total_sales FROM orders WHERE DATE(creation) = '$today' AND facilityID = '$facilityID'");
                                    ...
                                    $daily_sales_query = $con->query("SELECT SUM(CAST(subtotal AS DECIMAL(10,2)) - (CAST(item_discount AS DECIMAL(10,2)) * CAST(quantity AS SIGNED))) as total_sales FROM orders WHERE DATE(creation) = '$today'");
                            ...
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars(!empty($row['buyer_name']) ? $row['buyer_name'] : $row['customer_name']); ?></td>

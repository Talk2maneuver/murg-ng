...
?>
 <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <?php if (isset($_SESSION['facilityID'])){ ?>
                <div class="text-center">
                   <!-- <a href="./?switch_branch=" class="btn btn-primary btn-sm">Switch to Admin</a>-->
                </div>
                <?php } ?> 
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                       <!-- <a href="branch" aria-expanded="false" class="dropdown-toggle">-->
                            <div class="">
                    ...
                    <li class="menu">
                     ...
                     <li class="menu">
                        <a href="stocks" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="track-stock" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="store" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                                <span>Store</span>
                            </div>
                    ...
                    <li class="menu">
                        <a href="finished" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="starter-kit" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="sales_report"> Item Sales Report </a>
                            </li>
                        </ul>
                    </li>
                     <li class="menu">
                    ...
                    <li class="menu">
                        <a href="out" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="expense" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <!-- <li class="menu">
                        <a href="online" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-airplay">polyline points="5 9 2 12 5 15"></polyline><polyline points="9 5 12 2 15 5"></polyline><polyline points="15 19 12 22 9 19"></polyline><polyline points="19 9 22 12 19 15"></polyline><line x1="2" y1="12" x2="22" y2="12"></line><line x1="12" y1="2" x2="12" y2="22"></line></svg>
                                <span>Online</span>
                            </div>
